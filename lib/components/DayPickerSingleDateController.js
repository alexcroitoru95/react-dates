...
function (_ref) {
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (didDatesChange) {
      ...
      dates.map(function (newDate) {
        prevDates.map(function (prevDate) {
          if ((0, _moment["default"])(newDate).format(MOMENT_FORMAT) !== (0, _moment["default"])(prevDate).format(MOMENT_FORMAT)) {
