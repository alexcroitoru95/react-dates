...
function (_ref) {
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    var didDatesChange = dates !== prevDates;
    ...
    if (didDatesChange) {
      dates.map(function (newerDate) {
        prevDates.map(function (previousDate) {
          if ((0, _moment["default"])(newerDate).format(MOMENT_FORMAT) !== (0, _moment["default"])(previousDate).format(MOMENT_FORMAT)) {
            newDates.push(newerDate);
          }
        });
      });
